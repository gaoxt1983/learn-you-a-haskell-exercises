...
sumSquares a b = if a <= b then sq a + sumSquares (a + 1) b else 0
...
higherOrderSum intApplication a b = if a <= b then intApplication a + higherOrderSum intApplication (a + 1) b else 0
